...
export default async function(ctx) {
  ...
  // 落地IP + 从 ipinfo.io 获取精准 ASN
  let nIp = "获取失败", nLoc = "未知位置";
  let asnInfo = "未知";
